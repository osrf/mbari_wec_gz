...
void runTimer(buoy_utils::Stopwatch & _time)
{
  // Start the timer
...
TEST_F(Stopwatch, Constructor)
{
  ...
  buoy_utils::Stopwatch watch2(watch);
  EXPECT_EQ(watch, watch2);

  buoy_utils::Stopwatch watch3(std::move(watch2));
...
TEST_F(Stopwatch, EqualOperator)
{
  ...
  buoy_utils::Stopwatch watch;
  watch.SetClock(clock);
  buoy_utils::Stopwatch watch2;
  watch2.SetClock(clock);
  buoy_utils::Stopwatch watch3;
