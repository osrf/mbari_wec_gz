...
#ifndef BUOY_UTILS__STOPWATCHSIMTIME_HH_
#define BUOY_UTILS__STOPWATCHSIMTIME_HH_
...
{
  /// \brief Constructor.
  public: StopwatchSimTime();

  /// \brief Copy constructor
  /// \param[in] _watch The stop watch to copy.
  public: StopwatchSimTime(const StopwatchSimTime &_watch);

  /// \brief Move constructor
  /// \param[in] _watch The stop watch to move.
  public: StopwatchSimTime(StopwatchSimTime &&_watch) noexcept;

  /// \brief Destructor.
  public: virtual ~StopwatchSimTime();
  ...
  public: rclcpp::Time StartTime() const;
  ...
  public: rclcpp::Time StopTime() const;
  ...
  public: rclcpp::Duration ElapsedRunTime() const;
  ...
  public: rclcpp::Duration ElapsedStopTime() const;

  /// \brief Equality operator.
  /// \param[in] _watch The watch to compare.
  /// \return True if this watch equals the provided watch.
  public: bool operator==(const StopwatchSimTime &_watch) const;
  ...
  public: StopwatchSimTime &operator=(const StopwatchSimTime &_watch);

  /// \brief Move assignment operator
  /// \param[in] _watch The stop watch to move.
  /// \return Reference to this.
  public: StopwatchSimTime &operator=(StopwatchSimTime &&_watch);
...
#pragma warning(disable: 4251)
  ...
  private: std::unique_ptr<StopwatchSimTimePrivate> dataPtr;
#ifdef _WIN32
#pragma warning(pop)
#endif
};
