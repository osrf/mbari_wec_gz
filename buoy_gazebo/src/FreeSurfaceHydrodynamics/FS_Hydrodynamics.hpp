...
public:
  ...
  std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1>> fd_Mod_Xi;
  std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1>> fd_Pha_Xi;
  std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1>> fd_Re_Xi;
  std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1>> fd_Im_Xi;
  ...
  Eigen::Matrix<Eigen::VectorXd, 1, 6> m_IR_exc;

  // Vectors for numerical integration
  double m_dt = 0;
  Eigen::Matrix<Eigen::VectorXd, 6, 6> m_L_rad;
  Eigen::Matrix<Eigen::VectorXd, 1, 6> m_L_exc;

  // Storage for accelerations for each of 6 DOF
  Eigen::Matrix<Eigen::VectorXd, 1, 6> m_xddot;
