...
public:
  ...
  JustInterp::LinearInterpolator<double> hyd_eff_v,hyd_eff_m;
...
public:
  ...
  int operator()(const Eigen::VectorXd & x, Eigen::VectorXd & fvec) const
  {
    ...
    const double eff_m = this->hyd_eff_m(rpm);
    const double eff_v = this->hyd_eff_v(pressure);
