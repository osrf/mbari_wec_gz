...
class ElectroHydraulicPTOPrivate;
  ...
  /// Two ignition gazebo joints that are either prismatic or continous with 1DOF each, a
  /// desciption of the connections between actuator (joints), and an oil characteristic
  /// specification.
  ///
  /// ## System Parameters
  ///
